...
def run_centroid_tracking(video_path=DEFAULT_VIDEO_PATH, record=False, max_frames=None):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video", type=str, default=DEFAULT_VIDEO_PATH, 
                       help=f"Path to video file (default: {DEFAULT_VIDEO_PATH}, 'webcam' for camera)")
