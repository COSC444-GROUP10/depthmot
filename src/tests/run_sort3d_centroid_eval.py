...
def main(visualize=False):
    ...
    # Get the scripts directory and change to project root
    ...
    # Path to generate_sort3d_results_centroid.py in src/tests
    generator_script = os.path.join("src", "tests", "generate_sort3d_results_centroid.py")
