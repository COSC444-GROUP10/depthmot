...
def main():
    ...
    # Check if generate_baseline_sort_results.py exists
    if not os.path.exists("generate_baseline_sort_results.py"):
        print("Error: generate_baseline_sort_results.py not found.")
        sys.exit(1)
    ...
    for sequence in train_sequences:
        ...
        try:
            cmd = ["python", "generate_baseline_sort_results.py", "--sequences", sequence, "--output_dir", tracker_output_dir]
            if args.visualize:
